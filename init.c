...
void worker_thread_func(void *aux);

void cpu_monitor(void *aux);

void cpu_thread_monitor(void *aux);
...
thread_create("cpu_thread_monitor", PRI_DEFAULT, cpu_thread_monitor, NULL);
thread_create("cpu_monitor", PRI_DEFAULT, cpu_monitor, NULL);
